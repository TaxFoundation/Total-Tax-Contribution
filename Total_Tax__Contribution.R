...
#Read 2022 data for Non-OECD countries (BGR, HRV, MLT, ROU) and AUS + GRC + POL+ JPN for which 2023 data is incomplete or missing.
...
#Correcting  recurrent taxes on immovable property '4100' for CHL, ESP,ISR, ITA, NZL, PRT, USA (using distribution in tables A from OECD 2017 paper )
...
oecd_europe_national_currency_wide$"4120"<-ifelse(oecd_europe_national_currency_wide$iso_3== "ESP", oecd_europe_national_currency_wide$"4100"*4270/12478, oecd_europe_national_currency_wide$"4120")
...
#For the USA data comes from: https://www.cost.org/globalassets/cost/state-tax-resources-pdf-pages/cost-studies-articles-reports/score_ey-50-state-tax-burden-study_final_121824.pdf#page=7

oecd_europe_national_currency_wide$"4120"<-ifelse(oecd_europe_national_currency_wide$iso_3== "USA", oecd_europe_national_currency_wide$"4100"*0.541, oecd_europe_national_currency_wide$"4120")
oecd_europe_national_currency_wide$"4110"<-ifelse(oecd_europe_national_currency_wide$iso_3== "USA", oecd_europe_national_currency_wide$"4100"-oecd_europe_national_currency_wide$"4120", oecd_europe_national_currency_wide$"4110")

#Upload employment data % private/total employment
employment <- read_excel("Employment_Private_total.xlsx")

#Upload 2022 Public sector SSC as % of total SSC contribution for 2000 and 3000 (saved in 2000_gov and 3000_gov)
...
#For BGR, DNK, HRV, ISL, KOR, MLT, NLD, NZL, PRT, ROU that don't have public sector SSC % substitute 2000_gov and 3000_gov with % Public employment/ total employment
...
#Pass-through income as tax liability; save it in 1100_TL 
...
#Calculate Personal Income tax for public employees (non business remittance) and save it in 1100_NONB. Save personal income tax remitted by business in 1110_REM
...
#Correct 2100 and 2200 Social security contributions by employees/ employer to account only for private employment (remittance/liability9; the rest is non-business (public sector employees)
...
#Correct sales taxes for the US since sales taxes partially tax business inputs. In 2023, businesses paid 41.8% of the total sales tax collection (5112). Save in 5112_TL, the amount of sales taxes paid by businesses.Source: https://www.cost.org/globalassets/cost/state-tax-resources-pdf-pages/cost-studies-articles-reports/score_ey-50-state-tax-burden-study_final_121824.pdf#page=7
oecd_europe_national_currency_wide$"5112_TL"<- ifelse(oecd_europe_national_currency_wide$iso_3== "USA",(oecd_europe_national_currency_wide$"5112"*0.418),0)
oecd_europe_national_currency_wide$"5112"<- ifelse(oecd_europe_national_currency_wide$iso_3== "USA", (oecd_europe_national_currency_wide$"5112" - oecd_europe_national_currency_wide$"5112_TL"),oecd_europe_national_currency_wide$"5112")

#Calculate business tax liability, remittance, non-business and unallocable####
oecd_europe_national_currency_wide$TL<- oecd_europe_national_currency_wide$"1100_TL"+oecd_europe_national_currency_wide$"1200"+oecd_europe_national_currency_wide$"2200_TL"+ oecd_europe_national_currency_wide$"2300"+ oecd_europe_national_currency_wide$"3000_TL"+ oecd_europe_national_currency_wide$"4120"+ oecd_europe_national_currency_wide$"4220"+ oecd_europe_national_currency_wide$"5112_TL"+ oecd_europe_national_currency_wide$"5121"+ oecd_europe_national_currency_wide$"5122"+ oecd_europe_national_currency_wide$"5125"+ oecd_europe_national_currency_wide$"5126"+ oecd_europe_national_currency_wide$"5212"+ oecd_europe_national_currency_wide$"5213"+ oecd_europe_national_currency_wide$"5220"+ oecd_europe_national_currency_wide$"6100"
...
#Correct recurrent taxes on immovable property '4100' for Australia, Bulgaria, Canada, Costa Rica,Denmark, Estonia, Greece,Hungary, Ireland, Iceland, Japan, Korea, Luxembourg and Turkey to add them to Unallocable
...
colnames(data_Final)[colnames(data_Final)=="TL_SS"] <- "Business Liability Social Security Contribution"
colnames(data_Final)[colnames(data_Final)=="TL_income"] <- "Business Liability Corporate Income"
colnames(data_Final)[colnames(data_Final)=="TL_excise"] <- "Business Liability Excise taxes"
